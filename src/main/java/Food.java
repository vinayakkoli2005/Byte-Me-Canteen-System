...
public class Food {
    ...
    public Food(String name, double price, boolean available, String category) {
        ...
        } else if (category.equalsIgnoreCase("Meal") || category.equalsIgnoreCase("Meals")) {
            this.category = "Meals";
        } else {
    ...
    /** Creates a cart copy of this menu item (does not add to Prices queue). */
    public Food cartCopy(int quantity, String specialReq, String customerName) {
        Food copy = new Food(this.name, this.price, this.available, this.category);
        copy.Quantity = quantity;
        copy.Specialreq = specialReq;
